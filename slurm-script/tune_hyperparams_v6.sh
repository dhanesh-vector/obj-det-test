...
#SBATCH --output=/fs01/home/dhaneshr/code/obj-det-test/slurm-script/logs/yoloe_tune_v6_%A_%a.out
#SBATCH --error=/fs01/home/dhaneshr/code/obj-det-test/slurm-script/logs/yoloe_tune_v6_%A_%a.err

# ─── Config ───────────────────────────────────────────────────────────────────
PROJECT_DIR="/fs01/home/dhaneshr/code/obj-det-test"
CONFIG_FILE="${1:-train/config/best_hyperparams_v5_pu_loss.yaml}"
STUDY_NAME="yoloe_hparam_search_v6"
...
CKPT_DIR="${PROJECT_DIR}/checkpoints/hparam_v6"
...
python train/tune_hyperparams_v6.py \
    --config                    "$CONFIG_FILE" \
